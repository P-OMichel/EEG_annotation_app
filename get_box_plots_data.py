'''
Box plots of the different variables at the differents states
'''
...
#--- save
np.save('prop_delta', D_prop_delta, allow_pickle=True)
np.save('prop_alpha', D_prop_alpha, allow_pickle=True)
np.save('prop_beta', D_prop_beta, allow_pickle=True)
np.save('prop_gamma', D_prop_gamma, allow_pickle=True)
np.save('alpha_delta', D_alpha_delta, allow_pickle=True)
np.save('beta_delta', D_beta_delta, allow_pickle=True)
np.save('gamma_delta', D_gamma_delta, allow_pickle=True)
np.save('beta_alpha', D_beta_alpha, allow_pickle=True)
np.save('gamma_alpha', D_gamma_alpha, allow_pickle=True)
np.save('gamma_beta', D_gamma_beta, allow_pickle=True)
np.save('hf_lf', D_hf_lf, allow_pickle=True)
np.save('f_50_q', D_50_q, allow_pickle=True)
np.save('f_75_q', D_50_q, allow_pickle=True)
np.save('f_85_q', D_50_q, allow_pickle=True)
np.save('f_95_q', D_50_q, allow_pickle=True)
np.save('supp', D_supp, allow_pickle=True)
np.save('line_length', D_line_length, allow_pickle=True)
np.save('entropy', D_entropy, allow_pickle=True)
np.save('be', D_be, allow_pickle=True)